...
const ListingForm = (props) => {
    ...
    const { sale_type, price, bedrooms, home_type, bathrooms, square_foot, days_listed, has_photos, open_house, keywords } = formData;
    ...
    const onSubmit = e => {
       ...
       setLoading(true);
       axios.post('http://127.0.0.1:8000/api/listings/search',{sale_type, price, bedrooms, home_type, bathrooms,square_foot, days_listed, has_photos, open_house, keywords })
       .then( res=>
                {
                    setLoading(false);
        ...
        <form className='listingform' onSubmit={e => onSubmit(e)}>
            <div className='row'>
                <div className='col-1-of-6'>
                    ...
                    <div className='listingform__section'>
                        <label className='listingform__label' htmlFor='square_foot'>square_foot</label>
                        <select className='listingform__select' name='square_foot' onChange={e => onChange(e)} value={square_foot}>
                            <option>1000+</option>
                            <option>1200+</option>
                            <option>1500+</option>
                            <option>2000+</option>
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        ...
                        <select className='listingform__select' name='home_type' onChange={e => onChange(e)} value={home_type}>
                            ...
                            <option>House</option>
                            <option>commercialProperty</option>
