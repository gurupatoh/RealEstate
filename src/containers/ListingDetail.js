    ...
    return (
        <div className='listingdetail'>
            ...
            <div className='listingdetail__header'>
                ...
                <p className='listingdetail__location'>{listing.county}, {listing.town}</p>
            </div>
            <div className='row'>
            ...
            <div className='row'>
                <div className='col-1-of-2'>
                    <ul className='listingdetail__list'>
                        ...
                        <li className='listingdetail__list__item'>Square Feet: {listing.square_foot}</li>
                    </ul>
                </div>
                <div className='col-1-of-2'>
                    <ul className='listingdetail__list'>
                        ...
                        <li className='listingdetail__list__item'>City: {listing.county}</li>
                        <li className='listingdetail__list__item'>State: {listing.town}</li>
                    </ul>
                </div>
            </div>
            <div className='row'>
